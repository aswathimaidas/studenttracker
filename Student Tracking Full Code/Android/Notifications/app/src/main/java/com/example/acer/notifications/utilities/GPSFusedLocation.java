...
public class GPSFusedLocation implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationListener {
    Context context;
    private Location location;
    String TAG = "NOTIFICATIONPROJECT";
    ...
    public GPSFusedLocation(Context context) {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (location != null) {
            mLocation=location;
            Log.d(TAG, "onConnected: "+location.getLongitude()+","+location.getLatitude());
        }
