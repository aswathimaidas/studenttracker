...
?>
	 ...
	 <center>
    <a href="report.php" class="alert-link">Generate report</a>
    </center>
...
mysqli_query($con,"delete from history where id='$del_id'");
//if($del_id!="")
}
	?>
    <script>
...
return false;
	...
	<?php
		  ...
		  $result2 = mysqli_query($con,"SHOW FIELDS FROM sound_profile");
 ...
 <th>Del</th> 
  ...
  // $i=0;
   echo "<tbody>";
 	...
 	$result = mysqli_query($con,"SELECT * FROM sound_profile ");
